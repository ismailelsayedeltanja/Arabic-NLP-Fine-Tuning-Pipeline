...
Original file is located at
    https://colab.research.google.com/drive/1ggr3xZWg-B3DLEOZALqGfN5P5RWXvF9D
...
بنجهّز رسالة منظمة نبعتهـا للنموذج عشان يطلع  JSON مطابق  Pydantic Schema
"""
...
base_model_id = "Qwen/Qwen2.5-1.5B-Instruct"
local_model_path = "/content/drive/MyDrive/models/Qwen2.5-1.5B-Instruct"
...
if not model_is_valid(local_model_path):
    print("Model missing or incomplete — downloading...")
    os.makedirs(local_model_path, exist_ok=True)
    snapshot_download(repo_id=base_model_id, local_dir=local_model_path)
...
### String  ثم يولد الإجابة، ثم يستخرج النص الناتج من النموذج ويحوله إلى  LLM إلى Prompt يقوم بإرسال
"""
...
"""###SFT
### إنشاء Dataset للتدريب (SFT Dataset Generation) باستخدام Groq.
###هو يأخذ كل خبر → يرسل الخبر للنموذج → يستخرج البيانات المنظمة JSON → يحفظها في ملف JSONL جاهز للـ Fine-Tuning.
"""

raw_data_test = raw_data[:15]
...
###  يقوم بتحويل  Dataset التي أنشأتها سابقًا إلى الصيغة التي يفهمها LLaMA-Factory أثناء الـ Fine-Tuning
"""
...
# 
# ### output
# # resume_from_checkpoint: /gdrive/MyDrive/f-t-f/llm-finetuning/models/checkpoint-1500
# output_dir: /gdrive/MyDrive/f-t-f/llm-finetuning/models/
# 
# """gdrive/MyDrive/f-t-f/llm-finetuning/datasets/llamafactory-finetune-data/val.json
# """
# logging_steps: 10
# save_steps: 500
# plot_loss: true
...
!cd LLaMA-Factory/ && llamafactory-cli train /content/LLaMA-Factory/examples/ train_lora/news_finetune.yaml -q
...
finetuned_model_id = "/gdrive/MyDrive/f-t-f/llm-finetuning/models"
